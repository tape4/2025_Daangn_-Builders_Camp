...
class ItemLocationPanel extends StatefulWidget {
  final String region;
  ...
  @override
  State<ItemLocationPanel> createState() => _ItemLocationPanelState();
}

class _ItemLocationPanelState extends State<ItemLocationPanel> {
