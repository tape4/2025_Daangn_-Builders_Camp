...
가장 대표적인 것 중 하나가 채팅을 3rd-party의 sdk를 사용했다는 점 입니다. 실제로 유저들이 필요로 하는지, 좋아할지 아닐지도 모르는 기능을 백엔드와 프론트의 리소스를 들여 추가로 개발하고 추후 유저의 수가 늘어났을 때 트래픽을 고민하는 것이 손해라고 생각했습니다. 해서, Sendbird의 sdk를 사용했습니다. 
